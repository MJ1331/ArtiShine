...
# --------------------------
# 6. get_product_details_by_id (NEW - was missing from the file somehow? Wait, it should be here but let me check the end of the file)
# --------------------------
...
# --------------------------
# 7. update_product_partially (NEW)
# --------------------------
